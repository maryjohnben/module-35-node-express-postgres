...
function list() {
  return knex("restaurants as r").join("owners as o", "r.owner_id", "o.owner_id").select("r.restaurant_name", "o.owner_name", "o.email").orderBy("o.owner_name")
}

function listAverageRatingByOwner() {
  return knex("restaurants as r").join("owners as o", "r.owner_id", "o.owner_id").avg("r.rating").select("o.owner_name").groupBy("o.owner_name")
//   return [];
}
